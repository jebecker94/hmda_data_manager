...
# Clean Data
for column in ['income','loan_amount','interest_rate','combined_loan_to_value_ratio','debt_to_income_ratio','discount_points','loan_term','property_value'] :
...
outlier_threshold = stats.scoreatpercentile(anomaly_scores, 100*(1-outlier_fraction))
